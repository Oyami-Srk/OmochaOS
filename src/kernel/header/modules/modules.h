...
#define __MODULES_ENTRIES__ {(unsigned int)SysTask,(unsigned int)Task_TTY,(unsigned int)Task_HD}
#define __MODULES_PREFERRED_PID__ {(unsigned int)1,(unsigned int)0xFFFFFFFE,(unsigned int)0xFFFFFFFE}
