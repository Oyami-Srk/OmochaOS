...
#define __MODULES_ENTRIES__ {(unsigned int)SysTask,(unsigned int)Task_DEV,(unsigned int)Task_HD,(unsigned int)Task_VFS,(unsigned int)Task_Memory,(unsigned int)Task_TTY,(unsigned int)Task_FS}
